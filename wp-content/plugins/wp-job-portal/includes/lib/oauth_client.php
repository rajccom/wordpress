 ...
 * oauth_client.php
 *
 * @(#) $Id: oauth_client.php,v 1.183 2022/10/22 08:04:24 mlemos Exp $
...
<class>
  ...
  <version>@(#) $Id: oauth_client.php,v 1.183 2022/10/22 08:04:24 mlemos Exp $</version>
...
{/metadocument}
*/
  var $oauth_user_agent = 'PHP-OAuth-API (http://www.phpclasses.org/oauth-api $Revision: 1.183 $)';
...
*/
  ...
  Function GetStoredState(&$state)
  {
    ...
    if(IsSet($_SESSION[$this->session_name_prefix.'STATE']))
      ...
      $state = $_SESSION[$this->session_name_prefix.'STATE'] = time().'-'.substr(md5(rand().time()), 0, 6);
    return(true);
  }
