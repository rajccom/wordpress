...
<div id="wpjobportal-page-quick-actions">
	...
	<a class="wpjobportal-page-quick-act-btn multioperation" message="<?php echo esc_attr(WPJOBPORTALMessages::getMSelectionEMessage()); ?>" data-for="remove" confirmmessage="<?php echo __('Are you sure to delete', 'wp-job-portal') .' ?'; ?>"  href="#" title="<?php echo __('delete', 'wp-job-portal'); ?>">
