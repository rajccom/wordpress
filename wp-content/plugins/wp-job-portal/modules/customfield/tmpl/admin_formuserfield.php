            ...
            <div id="wpjobportal-wrapper-top-left">
                <div id="wpjobportal-breadcrumbs">
                    <ul>
                        ...
                        <li><?php echo __('Add User Field','wp-job-portal'); ?></li>
                    </ul>
                </div>
            </div>    
        ...
        <div id="wpjobportal-admin-wrapper">
            <form id="wpjobportal-form" class="wpjobportal-form" method="post" action="<?php echo esc_url(admin_url("admin.php?page=wpjobportal_fieldordering&task=saveuserfield")); ?>">
                <div class="wpjobportal-form-wrapper">
                    <div class="wpjobportal-form-title"><?php echo __('Field Type', 'wp-job-portal'); ?><span style="color: red;">*</span></div>
                ...
                <div class="wpjobportal-form-wrapper" id="for-combo-wrapper" style="display:none;">
                    <div class="wpjobportal-form-title"><?php echo __('Select','wp-job-portal') .' '. __('Parent Field', 'wp-job-portal'); ?><span style="color:red;">*</span></div>
                    <div class="wpjobportal-form-value" id="for-combo"></div>    	
                </div>
                <div class="wpjobportal-form-wrapper">
                    <div class="wpjobportal-form-title"><?php echo __('Field Title', 'wp-job-portal'); ?><span style="color: red;">*</span></div>
                ...
                <div class="wpjobportal-form-wrapper">
                    <div class="wpjobportal-form-title"><?php echo __('Show on listing', 'wp-job-portal'); ?></div>
                ...
                <?php if (wpjobportal::$_data[0]['fieldfor'] == 3) { ?>
                    <div class="wpjobportal-form-wrapper">
                        <div class="wpjobportal-form-title"><?php echo __('Resume Section', 'wp-job-portal'); ?><span style="color: red;">*</span></div>
                        <div class="wpjobportal-form-value">
                            <?php 
                                ...
                                echo '<span class="wpjobportal-fieldordering-warning">[ '.__('Section cannot be changeable in edit case','wp-job-portal').' ]</span>';
                            ?>
                        </div>
                    </div>
                <?php } ?>
                ...
                <div class="wpjobportal-form-wrapper">
                    <div class="wpjobportal-form-title"><?php echo __('Published', 'wp-job-portal');;//__('User Published', 'wp-job-portal'); ?></div>
                ...
                <div class="wpjobportal-form-wrapper">
                    <div class="wpjobportal-form-title"><?php echo __('Required', 'wp-job-portal'); ?></div>
                ...
                <div class="wpjobportal-form-wrapper">
                    <div class="wpjobportal-form-title"><?php echo __('Search', 'wp-job-portal');//__('User Search', 'wp-job-portal'); ?></div>
                ...
                <?php } ?>
                <div class="wpjobportal-form-wrapper">
                    <div class="wpjobportal-form-title"><?php echo __('Place Holder', 'wp-job-portal'); ?></div>
                ...
                <div class="wpjobportal-form-wrapper">
                    <div class="wpjobportal-form-title"><?php echo __('Description', 'wp-job-portal'); ?></div>
                ...
                <div class="wpjobportal-form-wrapper" id="divValues">
                    <div class="wpjobportal-form-title"><?php echo __('Options', 'wp-job-portal'); ?></div>
                    <div class="wpjobportal-form-value">
                        ...
                        <div class="wpjobportal-form-description"><?php echo __("Use enter key to separate options",'wp-job-portal'); ?>
                    </div>
                </div>
                ...
                <div class="wpjobportal-form-button">
                    <a id="form-cancel-button" class="wpjobportal-form-cancel-btn" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_fieldordering&ff='.$_GET['ff'])); ?>" title="<?php echo __('Cancel', 'wp-job-portal'); ?>"><?php echo __('Cancel', 'wp-job-portal'); ?></a>
