    ...
    <div id="wpjobportaladmin-data">
        ...
        <div id="popup_main" style="display:none;">
            <span class="popup-top">
                ...
                <img id="popup_cross" alt="<?php echo __('popup close','wp-job-portal'); ?>" title="<?php echo __('popup close','wp-job-portal'); ?>" onClick="closePopup();" src="<?php echo  WPJOBPORTAL_PLUGIN_URL;?>includes/images/popup-close.png">
            </span>
            <form id="wpjobportal-form" class="popup-field-from" method="post" action="<?php echo esc_url(admin_url("admin.php?page=wpjobportal_fieldordering&task=savesearchfieldordering&action=wpjobportaltask"));?>">
        ...
        <div id="wpjobportal-admin-wrapper" class="p0 bg-n bs-n">
            <!-- filter form -->
            <form class="wpjobportal-filter-form" name="wpjobportalform" id="wpjobportalform" method="post" action="<?php echo esc_url(admin_url("admin.php?page=wpjobportal_fieldordering&wpjobportallt=searchfields")); ?>">
            ...
            <?php if (!empty(wpjobportal::$_data[0])) { ?>
                <form  id="wpjobportal-form" class="search-fields-form wpjobportal-form" method="post" action="<?php echo esc_url(admin_url("admin.php?page=wpjobportal_fieldordering&action=wpjobportaltask&task=savesearchfieldorderingFromForm")); ?>">
                                    ...
                                    <tr id="id_<?php echo esc_attr($row->id); ?>" >
                                        ...
                                        <td  >
                                             <?php if($row->search_user == 1){ ?>
                                                <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/control_panel/dashboard/good.png" alt="<?php echo __('published', 'wp-job-portal'); ?>" title="<?php echo __('published', 'wp-job-portal'); ?>" />
                                             <?php }else{ ?>
                                        ...
                                        <td  >
                                            <?php if($row->search_visitor == 1){ ?>
                                                <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/control_panel/dashboard/good.png" alt="<?php echo __('published', 'wp-job-portal'); ?>" title="<?php echo __('published', 'wp-job-portal'); ?>" />
                                            <?php }else{ ?>
                                                <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/control_panel/dashboard/close.png" alt="<?php echo __('unpublished', 'wp-job-portal'); ?>" title="<?php echo __('unpublished', 'wp-job-portal'); ?>" />
                                            <?php } ?>
                                        </td>
                                        <td>
                                            <a class="wpjobportal-table-act-btn" href="#" onclick="showPopupAndSetValues(<?php echo esc_js($row->id); ?>,'<?php echo esc_js($row->fieldtitle);?>', <?php echo esc_js($row->search_user);?>, <?php echo esc_js($row->search_visitor);?>)" title="<?php echo __('edit', 'wp-job-portal'); ?>">
                                                <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/control_panel/dashboard/edit.png" alt="<?php echo __('edit', 'wp-job-portal'); ?>" title="<?php echo __('edit', 'wp-job-portal'); ?>">
                                            </a>
                                        </td>
                                    </tr>
                            <?php } ?>
                    ...
                    <div class="wpjobportal-filter-form-action-wrp">
                        <a class="wpjobportal-form-canc-btn" id="form-cancel-button" href="<?php echo admin_url('admin.php?page=wpjobportal_fieldordering&ff='.wpjobportal::$_data['fieldfor']); ?>" title="<?php echo __('cancel', 'wp-job-portal'); ?>">
