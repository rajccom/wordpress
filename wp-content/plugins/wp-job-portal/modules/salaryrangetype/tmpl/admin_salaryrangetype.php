...
<div id="wpjobportaladmin-wrapper">
    ...
    <div id="wpjobportaladmin-data">
            ...
            <div id="wpjobportal-wrapper-top-left">
                <div id="wpjobportal-breadcrumbs">
                    <ul>
                        ...
                        <li><?php echo __('Salary Range Type','wp-job-portal'); ?></li>
                    </ul>
                </div>
            </div>
        ...
        <div id="wpjobportal-admin-wrapper" class="p0 bg-n bs-n">
            ...
            <!-- filter form -->
            <form class="wpjobportal-filter-form" name="wpjobportalform" id="wpjobportalform" method="post" action="<?php echo admin_url("admin.php?page=wpjobportal_salaryrangetype"); ?>">
                <?php WPJOBPORTALincluder::getTemplate('salaryrangetype/views/filter');?>
            </form>
            <?php
                if (!empty(wpjobportal::$_data[0])) {
                    ?>
                    <form id="wpjobportal-list-form" method="post" action="<?php echo admin_url("admin.php?page=wpjobportal_salaryrangetype&task=saveordering"); ?>">
                        ...
                        <?php echo wp_kses(WPJOBPORTALformfield::hidden('_wpnonce', wp_create_nonce('delete-salaryrangetype')),WPJOBPORTAL_ALLOWED_TAGS); ?>
                ...
                <?php
                    ...
                    $link[] = array(
                                ...
                                'text' => __('Add New','wp-job-portal') .' '. __('Salary Range Type','wp-job-portal')
                            );
