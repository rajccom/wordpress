                        ...
                        <div class="wjportal-pkg-list-item-data">
                            <div class="wjportal-pkg-list-item-row">
                                ...
                                <span class="wjportal-pkg-list-item-row-val">
                                    <?php echo ($package->job==-1 ? esc_html(__('Unlimited','wp-job-portal')) : __(esc_html($package->job),'wp-job-portal')); ?>
                                </span>
                            </div>
                            <div class="wjportal-pkg-list-item-row">
                                <span class="wjportal-pkg-list-item-row-tit">
                                ...
                                <span class="wjportal-pkg-list-item-row-val">
                                    <?php echo ($package->job==-1 ? esc_html(__('Unlimited','wp-job-portal')) : __(esc_html($package->remjob),'wp-job-portal')); ?>
                                </span>
                            </div>
                            <div class="wjportal-pkg-list-item-row">
                                <span class="wjportal-pkg-list-item-row-tit">
                                ...
                                <span class="wjportal-pkg-list-item-row-val">
                                    <?php echo ($package->jobtime==-1 ? esc_html(__('Unlimited','wp-job-portal')) : __(esc_html($package->jobtime),'wp-job-portal'));
                                    echo ($package->jobtime==-1 ? esc_html(__('Unlimited','wp-job-portal')) : __(esc_html($package->jobtimeunit),'wp-job-portal'));
                                     ?>
                                </span>
                            </div>
                        </div>
