...
<div id="wpjobportaladmin-wrapper">
    ...
    <div id="wpjobportaladmin-data">
            ...
            <div id="wpjobportal-wrapper-top-left">
                <div id="wpjobportal-breadcrumbs">
                    <ul>
                        ...
                        <li><?php echo __('Add New Education','wp-job-portal'); ?></li>
                    </ul>
                </div>
            </div>
        ...
        <div id="wpjobportal-admin-wrapper">
            <form id="wpjobportal-form" class="wpjobportal-form" method="post" action="<?php echo esc_url(admin_url("admin.php?page=wpjobportal_highesteducation&task=savehighesteducation")); ?>">
