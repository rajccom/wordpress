...
<tr id="id_<?php echo esc_attr($row->id);?>">
    ...
    <td class="wpjobportal-text-left">
        <a href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_careerlevel&wpjobportallt=formcareerlevels&wpjobportalid='.$row->id)); ?>" title="<?php echo __('title','wp-job-portal'). ' : '; ?>">
    ...
    <td>
        ...
        <?php } else { ?>
            <a href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_common&task=makedefault&action=wpjobportaltask&for=careerlevels&id='.$row->id.$pageid)); ?>" title="<?php echo __('not default','wp-job-portal'); ?>">
    ...
    <td>
        <?php if ($row->status == 1) { ?> 
            <a href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_careerlevel&task=unpublish&action=wpjobportaltask&wpjobportal-cb[]='.$row->id.$pageid)); ?>" title="<?php echo __('published', 'wp-job-portal'); ?>">
        ...
        <?php } else { ?>
            <a href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_careerlevel&task=publish&action=wpjobportaltask&wpjobportal-cb[]='.$row->id.$pageid)); ?>" title="<?php echo __('not published', 'wp-job-portal'); ?>">
    ...
    <td>
        <a class="wpjobportal-table-act-btn" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_careerlevel&wpjobportallt=formcareerlevels&wpjobportalid='.$row->id)); ?>" title="<?php echo __('edit', 'wp-job-portal'); ?>">
        ...
        <a class="wpjobportal-table-act-btn" href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=wpjobportal_careerlevel&task=remove&action=wpjobportaltask&wpjobportal-cb[]='.$row->id),'delete-careerlevel')); ?>" onclick='return confirmdelete("<?php echo __('Are you sure to delete', 'wp-job-portal').' ?'; ?>");' title="<?php echo __('delete', 'wp-job-portal'); ?>">
