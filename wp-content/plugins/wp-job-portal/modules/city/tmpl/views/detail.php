 ...
 <tr>
	...
	<td>
		<?php if ($row->enabled == '1') { ?>
	        <a href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_city&task=unpublish&action=wpjobportaltask&wpjobportal-cb[]='.$row->id.$pageid)); ?>" title="<?php echo __('published', 'wp-job-portal'); ?>">
	    ...
	    <?php } else { ?>
	        <a href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_city&task=publish&action=wpjobportaltask&wpjobportal-cb[]='.$row->id.$pageid)); ?>" title="<?php echo __('not published', 'wp-job-portal'); ?>">
	...
	<td>
	    ...
	    <a class="wpjobportal-table-act-btn" href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=wpjobportal_city&task=removecity&action=wpjobportaltask&wpjobportal-cb[]='.$row->id),'delete-city')); ?>" onclick='return confirmdelete("<?php echo __('Are you sure to delete', 'wp-job-portal').' ?'; ?>");' title="<?php echo __('delete', 'wp-job-portal'); ?>">
