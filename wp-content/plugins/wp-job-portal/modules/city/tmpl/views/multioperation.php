...
<div id="wpjobportal-page-quick-actions">
    ...
    <a class="wpjobportal-page-quick-act-btn multioperation" message="<?php echo esc_attr(WPJOBPORTALMessages::getMSelectionEMessage()); ?>" confirmmessage="<?php echo __('Are you sure to delete','wp-job-portal').' ?'; ?>" data-for="removecity" href="#" title="<?php echo __('delete', 'wp-job-portal'); ?>">
